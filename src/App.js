              ...
              <div className="row portfolio-container" data-aos="fade-up" data-aos-delay="100">
                ...
                <div className="col-lg-6 col-md-6 portfolio-item filter-app">
                  <div className="portfolio-wrap">
                    ...
                    <div className="portfolio-links">
                      {/* <a href="https://quirky-torvalds-1b13a2.netlify.com" data-gall="portfolioGallery" className="venobox" title="App 1"><i className="bx bx-plus"></i></a> */}
                      <a href="https://earlsandwichshop.netlify.com" title="More Details"><i className="bx bx-plus"></i></a>
                      <a href="https://github.com/danielpullara/burgerking-website-.git" title="More Details"><i className="bx bx-link"></i></a>
                    </div>
                  </div>
                </div>
